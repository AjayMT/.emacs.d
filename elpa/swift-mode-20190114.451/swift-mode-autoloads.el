...
(defvar swift-mode:repl-executable (concat (when (executable-find "xcrun") "xcrun ") "swift") "\
...
(defvar swift-mode:swift-package-executable (concat (when (executable-find "xcrun") "xcrun ") "swift package") "\
...
(defvar swift-mode:swift-build-executable (concat (when (executable-find "xcrun") "xcrun ") "swift build") "\
Path to the Swift command for building.
The string is split by spaces, then unquoted.")

(custom-autoload 'swift-mode:swift-build-executable "swift-mode-repl" t)

(defvar swift-mode:debugger-executable (concat (when (executable-find "xcrun") "xcrun ") "lldb") "\
...
(defvar swift-mode:simulator-controller-executable (concat (when (executable-find "xcrun") "xcrun ") "simctl") "\
Path to the simulator controller command.
The string is split by spaces, then unquoted.")

(custom-autoload 'swift-mode:simulator-controller-executable "swift-mode-repl" t)

(defvar swift-mode:xcodebuild-executable (concat (when (executable-find "xcrun") "xcrun ") "xcodebuild") "\
